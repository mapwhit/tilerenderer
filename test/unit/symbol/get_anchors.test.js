...
test('getAnchors', async t => {
  ...
  await t.test('non-continued line with short labels', t => {
  ...
  await t.test('non-continued line with long labels', t => {
    const anchors = getAnchors(
      nonContinuedLine,
      smallSpacing,
      Math.PI,
  ...
  await t.test('continued line with short labels', t => {
    const anchors = getAnchors(
      continuedLine,
      bigSpacing,
      Math.PI,
  ...
  await t.test('continued line with long labels', t => {
    const anchors = getAnchors(
      continuedLine,
      smallSpacing,
      Math.PI,
  ...
  await t.test('overscaled anchors contain all anchors in parent', t => {
    const anchors = getAnchors(
      nonContinuedLine,
      bigSpacing,
      Math.PI,
