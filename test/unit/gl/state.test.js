...
test(
  'ClearColor',
  ValueTest.bind(ValueTest, ClearColor, {
...
test(
  'ClearDepth',
  ValueTest.bind(ValueTest, ClearDepth, {
    setValue: 0.5
  })
);
...
test(
  'ClearStencil',
  ValueTest.bind(ValueTest, ClearStencil, {
    setValue: 0.5
  })
);
...
test(
  'ColorMask',
  ValueTest.bind(ValueTest, ColorMask, {
...
test(
  'DepthMask',
  ValueTest.bind(ValueTest, DepthMask, {
    setValue: false
  })
);
...
test(
  'StencilMask',
  ValueTest.bind(ValueTest, StencilMask, {
    setValue: [0x00, 4]
  })
);
...
test(
  'StencilFunc',
  ValueTest.bind(ValueTest, StencilFunc, {
    setValue: {
...
test(
  'StencilOp',
  ValueTest.bind(ValueTest, StencilOp, {
...
test(
  'StencilTest',
  ValueTest.bind(ValueTest, StencilTest, {
    setValue: true
  })
);
...
test(
  'DepthRange',
  ValueTest.bind(ValueTest, DepthRange, {
    setValue: [0, 0.1]
  })
);
...
test(
  'DepthTest',
  ValueTest.bind(ValueTest, DepthTest, {
    setValue: true
  })
);
...
test(
  'DepthFunc',
  ValueTest.bind(ValueTest, DepthFunc, {
...
test(
  'Blend',
  ValueTest.bind(ValueTest, Blend, {
    setValue: false
  })
);
...
test(
  'BlendFunc',
  ValueTest.bind(ValueTest, BlendFunc, {
...
test(
  'BlendColor',
  ValueTest.bind(ValueTest, BlendColor, {
...
test(
  'Program',
  ValueTest.bind(ValueTest, Program, {
    equality: (a, b) => a === b,
...
test(
  'Viewport',
  ValueTest.bind(ValueTest, Viewport, {
    setValue: [0, 0, 1, 1]
  })
);
...
test(
  'BindFramebuffer',
  ValueTest.bind(ValueTest, BindFramebuffer, {
    equality: (a, b) => a === b,
...
test(
  'BindRenderbuffer',
  ValueTest.bind(ValueTest, BindRenderbuffer, {
    equality: (a, b) => a === b,
...
test(
  'BindTexture',
  ValueTest.bind(ValueTest, BindTexture, {
    equality: (a, b) => a === b,
...
test(
  'BindVertexBuffer',
  ValueTest.bind(ValueTest, BindVertexBuffer, {
    equality: (a, b) => a === b,
...
test(
  'BindElementBuffer',
  ValueTest.bind(ValueTest, BindElementBuffer, {
    equality: (a, b) => a === b,
    setValue: context.gl.createBuffer()
  })
);
...
test(
  'BindVertexArrayOES',
  ValueTest.bind(ValueTest, BindVertexArrayOES, {
    equality: (a, b) => a === b,
...
test(
  'PixelStoreUnpack',
  ValueTest.bind(ValueTest, PixelStoreUnpack, {
    setValue: 8
  })
);
...
test(
  'PixelStoreUnpackPremultiplyAlpha',
  ValueTest.bind(ValueTest, PixelStoreUnpackPremultiplyAlpha, {
    setValue: true
  })
);
